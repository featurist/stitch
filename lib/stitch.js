...
(function() {
  var CoffeeScript, Package, PogoScript, async, compilers, eco, extname, fs, join, normalize, sep, _, _ref,
  ...
  try {
    ...
    compilers.pogo = function(module, filename) {
      var content;
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      this.paths = (_ref2 = config.paths.map(normalize)) != null ? _ref2 : ['lib'];
